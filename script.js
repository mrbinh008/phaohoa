...
function init() {
    ...
    let content = params.get("t");
    if (!content) {
        content = "Năm mới chúc bạn thực hiện được những dự định còn dang dở," +
            " quen thêm những người bạn mới, đến những vùng đất mới." +
            "Chúc bạn 12 tháng phú quý, 365 ngày phát tài, 8.760 giờ sung túc, 525.600 phút thành công và 31.536.000 giây mã đáo.";
    }
    typeEffect(modalText, content, 100);
